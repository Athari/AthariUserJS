...
A collection of user scripts by @Athari.
...
3. Go to the user script and **click on its ![User Script Install][Install Script] badge**. You'll see a preview of the script.

4. **Click on the ![Install][Install Script Monkey] button** in the top panel.
