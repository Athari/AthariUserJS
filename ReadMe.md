...
This user script is designed to be used in conjunction with the [user style "Kinorium.com – Enhanced"](https://github.com/Athari/AthariUserCCC#kinorium) [![Install Kinorium.com Enhanced Script][Install Style]](https://github.com/Athari/AthariUserCSS/blob/master/Kinorium/Kinorium-Enhanced.user.css?raw=1).
